...
def put_highlighted_text(frame, message, position, font_face, font_scale, color, thickness):
    cv2.putText(frame, message, position, font_face, font_scale, color, thickness) # white border
...
class PerformanceMetrics:
    ...
    def paint_metrics(self, frame, position=(15, 30), font_scale=0.75, color=(223, 202, 159, 255), thickness=2):
    ...
    def log_total(self):
        ...
        log.info(f"Processed frames {self.total_statistic.frame_count + self.current_moving_statistic.frame_count}")
